...
from drl_hw1.utils.make_train_plots import make_train_plots
from drl_hw1.utils.gym_env import GymEnv
from drl_hw1.samplers.trajectory_sampler import sample_paths_parallel
import numpy as np
import pickle
...
def train_agent(job_name, agent,
    ...
    for i in range(niter):
        ...
        if evaluation_rollouts is not None and evaluation_rollouts > 0:
            ...
            # print("Params", agent.policy.trainable_params)
